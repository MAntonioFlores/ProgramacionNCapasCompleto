...
namespace PL
{
    public class UsuarioLINQ
    {
        public static void AddLINQ()
        {
            ...
            var resultado = BL.UsuarioLINQ.AddLINQ(usuario);
        ...
        public static void UpdateLINQ()
        {
            ...
            //Console.WriteLine("Escriba su Imagen");
            //usuario.ApellidoMaterno = Console.ReadLine();
            Console.WriteLine("Escriba el ID al que Se Aplicaran los Cambios");
            usuario.IdUsuario = (int)Convert.ToInt64(Console.ReadLine());

            var resultado = BL.UsuarioLINQ.UpdateLINQ(usuario);
        ...
        public static void DeleteLINQ()
        {
            ...
            var resultado = BL.UsuarioLINQ.DeleteLINQ(usuario);
        ...
        {
            var usuario = BL.UsuarioLINQ.GetAllLINQ();
        ...
        public static void GetByIdLINQ()
        {
            ...
            var resultado = BL.UsuarioLINQ.GetByIdLINQ(idUsuario);
