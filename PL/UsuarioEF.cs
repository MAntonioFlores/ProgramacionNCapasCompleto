...
namespace PL
{
    public class UsuarioEF
    {
        public static void AddEF()
        {
            ...
            var resultado = BL.UsuarioEF.AddEF(usuario);
        ...
        public static void UpdateEF()
        {
            ...
            var resultado = BL.UsuarioEF.UpdateEF(usuario);
        ...
        public static void DeleteEF()
        {
            ...
            var resultado = BL.UsuarioEF.DeleteEF(usuario);
        ...
        {
            var usuario = BL.UsuarioEF.GetAllEF();
        ...
        public static void GetByIdEF()
        {
            ...
            var resultado = BL.UsuarioEF.GetByIdEF(idUsuario);
